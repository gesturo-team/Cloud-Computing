...
async function alphabet(req, res) {
    try {
        ...
        const snapshotAlphabet = await db.collection('dictionary').doc('alphabet').collection('wordList').get();
...
async function number(req, res) {
    try {
        ...
        const snapshotNumber = await db.collection('dictionary').doc('number').collection('wordList').get();
